        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I perform exploratory data analysis, cleaning, and feature
                preparation to uncover trends and support practical decision-making.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Predictive Models and Evaluation</h4>
              <p>
                I build supervised and unsupervised learning workflows, evaluate
                performance, and present model-driven findings for real use cases.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
